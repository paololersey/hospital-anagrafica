...
public class ClienteWithProdottoSearchTO implements java.io.Serializable {
	...
	public ClienteWithProdottoSearchTO() {

	}

	public ClienteWithProdottoSearchTO(String nome, String cognome, Date dataNascita, String codiceFiscale,
